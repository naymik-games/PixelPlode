...
func _draw():
	if is_stopped:
		...
		#draw_colored_polygon($blast_radius/CollisionShape2D.polygon,Color.DARK_CYAN)
		draw_polyline($blast_radius/CollisionShape2D.polygon,Color.DARK_CYAN, 2.0, false)
